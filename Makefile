CC = clang -fPIC -mavx -O2 -S -std=c11 -Wall -Wextra -Wc++-compat -I include -I src/inline
CC4 = clang -fPIC -mavx -O3 -S -std=c11 -Wall -Wextra -Wc++-compat -I include -I src/inline
Cxx = clang -fPIC -mavx -O2 -S -std=c++11 -Wall -Wextra -I include -I src/inline
...
bin/mean.s: src/mean.c include/mean.h include/convert.h src/inline/sigmautil.h
	$(CC4) src/mean.c -o bin/mean.s
	
bin/median.s: src/median.c include/median.h include/convert.h src/inline/sigmautil.h
